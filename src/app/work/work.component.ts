  ...
  resumeData: CardWide[] = [
    {
      ...
      bulletPoints: [
        "Collaborated extensively with cross-functional teams on diverse projects, contributing to the development of web applications for clients. Applied a range of technologies, including JavaScript, TypeScript, Angular, React and other modern frameworks to deliver versatile and impactful solutions."
      ]
    },
    {
